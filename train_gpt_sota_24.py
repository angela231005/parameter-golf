# ==========================================================
# IDEA 24: 3-Lane Parallel Residual (Attn + LocalAttn + MLP)
# Third lane: sliding-window local attention. Three expert lanes, cross-lane lambdas.
# Base: train_gpt_sota_17.py  —  [IDEA-24] marks changes
# ==========================================================
...
class Hyperparameters:
    ...
    local_attn_window = int(os.environ.get("LOCAL_ATTN_WINDOW", "128"))  # physical layer idx — L5+ = all decoder layers
