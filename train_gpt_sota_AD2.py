# ============================================================
# train_gpt_sota_AD2.py  —  Developed from strategy_AD
# ============================================================
# New ideas (not from sota_22c):
#   [AD2-1] RECUR_COUNT: repeat recur_layers N times (default=2, giving 3 total passes)
#           Leverages weight-shared depth recurrence more aggressively.  Free compute
#           since weights are shared; only activation memory grows.
#   [AD2-2] TTT AdamW: replace SGD (momentum) with AdamW in test-time training.
#           AdamW adapts per-parameter LR, faster convergence on val chunks.
#   [AD2-3] Dynamic EMA: fast EMA early (explore), slow EMA late (stabilise).
#           Schedule: frac<0.3 → ema_decay_early, frac>0.7 → ema_decay_late.
#           Keeps good early-training signal without letting late noise contaminate EMA.
# ============================================================
import copy
import glob
import io
