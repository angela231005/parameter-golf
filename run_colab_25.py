...
# # Parameter Golf — SOTA_25 Training Run
# Built on sota_24. Key change: **Raki v6 weight decay scheme (Modification 3)**
#
# **Changes vs sota_24:**
# - MUON_WD=0.090 (was 0.04) — Raki v6 "Modification 3: weight decay 0.090"
# - EMBED_WD=0.090 (was 0.04 via adam_wd) — separate embed weight decay matching Raki
# - ADAM_WD=0.02  (was 0.04) — lower scalar/control param WD matching Raki
# - train_gpt_sota_25.py: embed_wd param added so tok optimizer uses EMBED_WD not ADAM_WD
#
# **Inherited from sota_24 (unchanged):**
...
env = " ".join([
    ...
    f"MUON_WD=0.090",                 # was 0.04; Raki: 0.090 for matrix params
    f"EMBED_WD=0.090",                # was 0.04; Raki: 0.090 for embeddings
    f"ADAM_WD=0.02",                  # was 0.04; Raki: 0.02 for scalar/control params
    # --- LAWA ---
    f"LAWA_ENABLED=1",
    f"LAWA_K=15",
    f"LAWA_FREQ=50",
...
cmd = f"{env} torchrun --standalone --nproc_per_node={NPROC} train_gpt_sota_25.py"
print("Command:")
print(cmd)
